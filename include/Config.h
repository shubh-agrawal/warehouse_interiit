...
#define N_SLICE_H 25	//Number of height slices of image for contour detection
#define N_SLICE_W 25	//Number of width slices of image for contour detection 
...
#define BAR_CAM "/ardrone/image_raw"
